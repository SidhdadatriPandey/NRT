...
const ClientExperience = () => {
    ...
    return (
        <div className='flex flex-col gap-y-2 justify-center items-center bg-[#a4a8af] py-10 rounded-lg' >
            <h3>Testimonials</h3>
            <h4 className='text-[44px] font-semibold px-[350px] text-center'>Some Expressions Of Our Clients</h4>
            <div>
                <div className='flex justify-between w-[1000px] p-9'>
                    <div>
                        <div className='flex flex-col items-center w-[794px] h-[205px] gap-y-9 bg-white p-5 rounded-lg'>
                ...
                <div className='flex gap-x-40 items-center justify-between w-1/2 relative px-9 left-[350px]'>
